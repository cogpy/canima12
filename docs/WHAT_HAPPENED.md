# What Happened: The Complete Narrative

**Case 2025-137857 — Revenue Stream Hijacking, Trust Fraud, and Corporate Sabotage**

**Date:** 2026-04-30 | **Source:** Exchange Mailbox Evidence (~1M messages, 112 users, 2014–2026)

---

## I. Prologue: The Family Business

The RegimA group of companies is a South African skincare manufacturing and distribution business built over decades by Peter and Jacqueline Faucitt. Their son, Daniel Faucitt, an electronic engineer by training, built the company's entire e-commerce and digital infrastructure — the Shopify stores, the Stock2Shop integration, the Sage accounting pipeline, the Cloudflare-hosted websites, and the logistics APIs that connected them all. Daniel and Peter were co-directors of **RegimA Worldwide Distribution (Pty) Ltd** and **Strategic Logistics CC**, each holding a 33% stake alongside the **Faucitt Family Trust (FFT)**.

The business employed a bookkeeper named **Rynette Farrar**, who over time assumed control of the financial systems. Rynette operated Peter's email address (`pete@regima.com`), controlled the Sage accounting system, managed the banking relationships, and directed the day-to-day financial operations. Peter himself, as established in formal notices, **does not use electronic communication systems**. Every digital communication attributed to "Peter" was, in reality, authored by Rynette.

The family's accountant, **Danie Bantjies** (SAICA 00105928), served as the external accountant for all companies associated with Peter, Jacqueline, and Daniel. He was also the CFO of the **George Group**, whose CEO, Kevin Derrick, is the director of **Ketoni Investment Holdings** — a company that owes the Faucitt Family Trust **ZAR 18.685 million**, payable in May 2026.

---

## II. The Motive: R18.685 Million

In April 2023, the Faucitt Family Trust invested in Ketoni Investment Holdings. Exchange records from **19 April 2023** show Marc Yudaken of Baker McKenzie forwarding correspondence regarding "Ketoni Investment Holdings," with Rynette arranging the Zoom meeting for Peter in the boardroom. The investment carried a three-year payout schedule, with the first window opening in **May 2026**.

This R18.685 million payout is the gravitational centre of everything that followed. Every action taken by the conspirators — the trust forgery, the accounting sabotage, the revenue diversion, the fraudulent interdict, and the contempt application — converges on a single objective: to ensure that when the Ketoni payout arrives, the people who control the Trust are not Daniel and Jacqueline, but Rynette and Bantjies.
...
By **November 2023**, Rynette initiated the first attempt to change the Sage admin username, as documented in the exchange records. The "sinking" problems between Sage and Shopify were already appearing, with Rynette emailing clients in November 2023: *"We have a problem with the sinking from Sage to Shopify. I have reported the problem."*
...
### The Sage System Sabotage and Premeditated Entrapment — 8-9 July 2024

Ten days after the trust forgery, Peter Faucitt and Rynette Farrar executed a deliberate sabotage of the company's accounting infrastructure. On **8 July 2024**, Peter personally signed a Sage Business Cloud Accounting Disclaimer Form to transfer the admin account from the deceased Kayla Pretorius to himself. 

The form explicitly stated: **"all other users... will no longer have access to the company dataset/s."** Peter signed this knowing it would revoke all access. On **9 July 2024**, Rynette submitted the sworn affidavit and forms to Sage, CC'ing Peter. Sage confirmed the transfer, which immediately broke all API integrations with Shopify, Stock2Shop, and bank feeds.

Thirteen months later, Peter obtained an *ex parte* interdict against Daniel, claiming mismanagement of the companies — while concealing from the court that he had personally authorized the sabotage of the very systems he was complaining about. This establishes **provable foreknowledge** and premeditated entrapment.

### The Sage Fraud (Historical Context)

Ten days after the forgery, Peter Faucitt swore a false affidavit to Sage, claiming that Kayla Pretorius, the account owner, had recently died and that ownership should be transferred to `pete@regima.zone`. On **9 July 2024**, Sage executed the transfer.

The immediate consequence was the complete severance of the **Stock2Shop-to-Sage invoice pipeline**. Every order placed on the Shopify portal could no longer synchronise with the accounting system. Rynette's own words, captured in the exchange records, confirm both the breakage and her foreknowledge:

> *"the orders coming in on the Shopify portal, but it is not sinking with SAGE"*

She then attempted to reverse the damage, revealing that she understood the full scope of the consequences:

> *"is it possible that we can leave Kayla as the owner for now, as apparently all sorts of connectors are connected to her email address?"*

The Stock2Shop team spent ten days (10–19 July 2024) reconfiguring all portals from Kayla's credentials to Pete's. But the damage was done. The deliberate breakage of the accounting pipeline created an information vacuum — a period where financial data was unreliable, invoices were not being generated, and the books were in disarray. This manufactured chaos would later be weaponised as "evidence" of Daniel's alleged financial mismanagement.

---

## VI. The Slow Strangulation: 2025

### The Letter of Demand Evidence (March 2026)

A comprehensive Letter of Demand was prepared containing 94 PDF evidence emails organized into 7 distinct allegation categories:
1. **Payment Diversion** (19 PDFs) - Banking detail change letters to customers
2. **Unlawful Bank Account Control** (14 PDFs)
3. **UK Business Revenue Theft** (20 PDFs) - via regimaskin.co.za
4. **Unlawful Competition** (14 PDFs) - via Addarory (Rynette's son's company)
5. **Pilfering Business Opportunities** (2 PDFs)
6. **Brand Damage** (6 PDFs)
7. **Stock Theft / R5.4M Adjustment Fraud** (19 PDFs)

This documentary evidence establishes the total quantum of the fraud: R5.4M in stock adjustments, R1M+ in monthly revenue theft, and R850K in unauthorized transfers.
...
The revenue diversion began in earnest. Exchange records from **2 May 2025** show Kent Rault sending emails to clients:
...
With the revenue streams diverted, the accounting system under their control, and Daniel's cards cancelled, the conspirators moved to the legal endgame.

### 11 August 2025 — The Backdated Appointment

Rynette emailed Bantjies a "Main Trustee" agreement, backdated to **1 July 2025**. This document formalised Bantjies' role and gave him the standing to swear an affidavit in support of the interdict application.

### 13 August 2025 — The Perjured Affidavit

Bantjies swore a confirmatory affidavit in support of Peter's founding affidavit. This was **68 days** after Daniel had reported the fraud to Bantjies personally. Bantjies knew the claims in Peter's affidavit were false — he had received Daniel's detailed fraud report, forwarded it to his work email, and yet certified a document that directly contradicted what he knew to be true.

Peter's founding affidavit claimed Daniel had made "unauthorized transactions" — the very transactions that FNB's own FICA/KYC records confirmed Daniel was solely authorised to make. Peter concealed the SOLE mandate, the FNB legal letter, the card sabotage, and the R500K reimbursement context. The "financial chaos" Peter described was the direct, engineered consequence of Rynette's own Sage sabotage.

### 14 August 2025 — Filed via Court Online

The interdict application was filed electronically at **08:16:25 SAST**.

### 19 August 2025 — The Interdict Granted

The court, hearing only Peter's side of the story (*ex parte*), granted the interdict. Daniel and Jacqueline were stripped of their ability to operate the companies. Peter — and by extension, Rynette — had sole control.

---

## VII. The Aftermath: Extraction and Weaponisation

### R10.6 Million Extracted — September 2025

Within **8 days** of the interdict being granted, **R10.6 million** was extracted from the company accounts. The speed of this extraction suggests it was pre-planned, awaiting only the legal cover of the court order.

### The Settlement Trap — September 2025

On **18 September 2025**, settlement agreements were presented at a mediation facilitated by Forvis Mazars. Daniel and Jacqueline later withdrew from these agreements on **22 September 2025**, citing duress. Their own attorneys, ENS Africa, appeared to be acting in the interests of the opposing party rather than their clients. Upon withdrawal, ENS became hostile, threatening that the Faucitts would not "escape the consequences of the settlement agreement."

### The Contempt Weapon — February 2026

On **4 February 2026**, Peter filed a contempt of court application against Jacqueline Faucitt, seeking **six months' imprisonment** for alleged non-compliance with the interdict. This is the final act of weaponisation: using a court order obtained through perjury, material non-disclosure, and fraud to imprison a victim of the very fraud that produced the order.

---

## VIII. The Pattern: What the Emails Reveal

The exchange evidence, read as a whole, reveals a pattern that is unmistakable in its clarity and devastating in its implications.
...
## IX. The Answer to "What Happened"

Yes, we can see it. The emails tell the story with brutal clarity.

**What happened is this:** A bookkeeper named Rynette Farrar, operating under the identity of the company's founder, Peter Faucitt, systematically seized control of a family business and its trust. She forged a trust amendment to install an insider — the accountant Bantjies, who had access to a R18.685 million investment payout — as a trustee. She deliberately broke the company's accounting infrastructure and then used the resulting chaos to frame the legitimate director, Daniel Faucitt, for financial mismanagement. She diverted the company's revenue streams to accounts she controlled. And when Daniel discovered the fraud and reported it, she weaponised the legal system — obtaining a fraudulent court order through perjury and using it to strip him and his mother of their rights, extract millions from the company, and ultimately seek to imprison Jacqueline Faucitt for non-compliance with an order that was void from its inception.

Every step was documented in their own emails. Every lie was contradicted by their own words. Every act of sabotage was timestamped by the systems they broke. The evidence is not circumstantial — it is contemporaneous, documentary, and irrefutable.

The interdict is **void ab initio**. The contempt application is an abuse of process. The fraud exceeds **R63 million**. And the Ketoni payout — the prize they were all reaching for — is due in three months.

---

*Source: NeonExo1 Exchange Evidence Pipeline — Super-Sleuth + Hyper-Holmes Analysis*
*Exchange Database: ~1,000,000 messages | 112 users | 2014–2026*
*Evidence Chains: 329 messages across 8 validated chains*
