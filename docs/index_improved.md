...
This documentation repository provides comprehensive evidence and analysis of the systematic hijacking of revenue streams in the RegimA business operations case. The case involves **three sequential interdict applications** filed over a 6-month period (March-November 2025), documenting **R10,269,727.90** in total documented losses.
...
- **Financial Manipulation:** 13 events diverting and concealing funds
...
**[View Full Application Details](application-1.md)** | **[Evidence Summary](application-1-evidence.md)**
...
**[View Full Application Details](application-2.md)** | **[Evidence Summary](application-2-evidence.md)**
...
**[View Full Application Details](application-3.md)** | **[Evidence Summary](application-3-evidence.md)**
