...
**Document:** KL0034 — Letter of Demand from Elliott Attorneys (26 November 2025)  
**On Behalf of:** Rynette Farrar  
**Addressed to:** Pottas Attorneys (for Jacqueline Faucitt)  
**Case:** 2025-137857
...
## Allegation-by-Allegation Evidence Analysis

### Allegation 1: Payment Diversion (para 75)
...
### Allegation 2: Unlawful Bank Account Control (para 66, 146, 148)
...
### Allegation 4: Unlawful Competition via Addarory (para 95-97, 130-132)
...
### Allegation 6: False Photos / Brand Damage (para 119, 137)

> *"Alleges that photos posted or circulated by our client were false, misleading, detrimental to the RegimA brand, and created an unauthorised false affiliation."*

**VERDICT: PROVEN TRUE — Unauthorized use of RegimA brand on competing domain**
...
### Allegation 7: Stock Theft Risk (para 114-115)
...
## Conclusion: The Letter of Demand Is Evidence of Witness Intimidation

The KL0034 Letter of Demand, far from being a legitimate legal instrument, is itself evidence of **witness intimidation**. Every allegation made by Jacqueline Faucitt in her answering affidavit is supported by extensive email evidence from the corpus. The demand for retraction, apology, and cease-and-desist within 48 hours was an attempt to:

1. **Suppress truthful testimony** in active court proceedings
2. **Intimidate a witness** (Jacqueline) from making further disclosures
3. **Create a chilling effect** on future affidavits and legal filings
4. **Establish a false narrative** that the allegations were "defamatory" when they were factual

The threat of criminal complaint for *crimen injuria* is particularly egregious, as truth is a complete defence to defamation in South African law. The email evidence proves that every allegation was not only true but understated.

### Legal Implications

| Implication | Basis |
|-------------|-------|
| **Witness Intimidation** | Criminal Procedure Act, s 189 — attempting to influence a witness |
| **Obstruction of Justice** | Common law — attempting to suppress truthful testimony |
| **Abuse of Process** | Threatening legal action to suppress truth in active proceedings |
| **Evidence of Consciousness of Guilt** | The demand itself proves Rynette knew the allegations were true and sought to suppress them |
...
| Source | Location |
|--------|----------|
| KL0034 PDF | `docs/evidence-suppression/documents/KL0034-LetterofDemand-26.11.2025.pdf` |
| KL0034 PDF (ad-res-j7) | `ANNEXURES/JF13/KL0034-LetterofDemand-26.11.2025.pdf` |
| Email corpus | Neon PostgreSQL (exchange_sync.messages) — 1,070,000+ emails |
| Cloudflare AI Search | AutoRAG endpoint |
