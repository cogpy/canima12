...
### Introduction: The Anatomy of a Corporate Hijacking

At its core, Case 2025-137857 is not a standard family dispute, despite being filed in family court. It is a highly coordinated commercial crime and trust fraud operation with a total financial impact exceeding **R63,000,000**. 

The enterprise was orchestrated primarily by **Peter Faucitt** (Founder of the Faucitt Family Trust and company director) and **Rynette Farrar** (the company bookkeeper), with the strategic assistance of **Daniel Jacobus Bantjies** (an external accountant unlawfully appointed as a Trustee). 

Their goal was twofold: 
1. Siphon profits from the operational companies (like RegimA Worldwide Distribution) into entities they exclusively controlled (like Villa Via).
2. Neutralize any beneficiaries who stood in the way of a massive impending trust payout.

---

### Chapter 1: The Hidden Motive and the Setup (April 2023 – July 2024)

To understand the events of 2025, one must look at the financial horizon of 2026. 

On **24 April 2023**, the Faucitt Family Trust (FFT) invested in Ketoni Investment Holdings. This investment carries a massive **ZAR 18.75 million payout option** due in **May 2026**. As a 1/3 beneficiary of the trust, Daniel Faucitt is legally entitled to ZAR 6.25 million of this payout. 
...
### Chapter 2: The Discovery and the Spark (May – June 2025)

The carefully constructed financial facade began to crack in early 2025. 

Daniel Faucitt, acting in his capacity as CIO and a 33% shareholder in Strategic Logistics Group (SLG) and RegimA Worldwide (RWW), began uncovering massive financial anomalies. He discovered that **R5.4 million in stock** had vanished from SLG, and that RWW was being used as an "expense dumping ground" to absorb costs that benefited other entities, while profits were extracted via inflated rent charges to Villa Via (an entity 50% owned by Peter).

On **26 May 2025**, the collusion between the accountant and the bookkeeper was captured in what is now known as the **"46-Second Smoking Gun" (Evidence: EVENT_137)**. At 13:06:43, Bantjies emailed the directors claiming "impartiality" regarding the financial anomalies. Exactly 46 seconds later, he forwarded that same email to Rynette Farrar with the explicit Afrikaans instruction: *"Ek dink nie jy moet sê ek het hierdie met jou gedeel nie asb."* ("I don't think you should say I shared this with you please.")

Unaware that Bantjies was secretly a Trustee and actively colluding with Rynette, Daniel compiled a comprehensive fraud report detailing the revenue stream hijacking. On **6 June 2025**, Daniel sent this report directly to Bantjies, expecting the "independent accountant" to take action.

---

### Chapter 3: The Retaliation and Cover-Up (June – July 2025)

The response to Daniel's whistleblowing was immediate, aggressive, and retaliatory.
...
### Chapter 4: The Legal Weaponization (August 2025)

Having crippled Daniel financially and locked him out of the corporate systems, Peter and Bantjies moved to neutralize him legally. 

On **11 August 2025**, Jacqui Faucitt signed a document backdating Peter's designation as "Main Trustee" to 1 July 2025. Two days later, on **13 August 2025**, Peter and Bantjies filed an *ex parte* (one-sided) urgent application against Daniel and Jacqui in the High Court.

Crucially, they engaged in **forum shopping**. Instead of filing in a commercial court where financial fraud is adjudicated, they filed in a family court. Their strategy was to weaponize "medical testing"—claiming Daniel was mentally unfit—to push for a curatorship. If Daniel were placed under curatorship, he would lose control of his assets, including his ZAR 6.25 million share of the impending Ketoni payout.

On **19 August 2025**, based on affidavits sworn by Peter and Bantjies that contained deliberate, material non-disclosures (perjury), the court granted an interim interdict. Under South African law, an order obtained by fraud on the court is *void ab initio* (void from the beginning).

---

### Chapter 5: The Laws Broken

The evidence compiled in the `ad-res-j7` repository demonstrates severe violations of South African law across multiple domains.

#### 1. Companies Act 71 of 2008
- **Section 76 (Fiduciary Duties):** Breached by Peter Faucitt and Daniel Bantjies through active collusion to deceive the board (proven by the 46-second smoking gun email).
- **Section 29 (Falsification of Records):** Breached by Rynette Farrar and Bantjies by covering up the R4.2 million stock discrepancy and backdating journal entries.
- **Section 214 (False Statements & Reckless Conduct):** Breached by the creation of inexplicable year-end invoices and backdated financial statements.
...
Case 2025-137857 is a textbook example of corporate capture. By combining financial manipulation, digital identity theft, and the abuse of *ex parte* court procedures, the perpetrators attempted to hijack a multi-million Rand enterprise and strip a legitimate beneficiary of his rights ahead of a massive trust payout. The forensic evidence, however, has preserved the truth.

*For full evidentiary cross-references, please see the [Comprehensive Evidence Index](./evidence-index-enhanced.md) and the [Master Timeline](./timeline.md).*
