...
| Entity | Correction |
|--------|------------|
| **Linda Kruger** | Office employee (bookkeeper/sales) — NOT a family member. Previously incorrectly described as "Rynette's sister." |
| **Gayane Williams** | Office employee — NOT a family member. Correctly identified from email signatures. |

## Group A: Court Proceedings

| Filing Type | Latest Version | Burden of Proof | Composed Score | XV-Score | Status |
|-------------|----------------|-----------------|----------------|----------|--------|
| **1. Civil Action (s163 Oppression)** | [Civil Action Summons](./civil_action_summons_REFINED_2026_01_18.md) | Civil (50%) | 86.07% | 90.25% | **MET** |
| **1. Criminal Case Submission** | [Criminal Submission](./criminal_case_submission_REFINED_2026_01_18.md) | Criminal (95%) | 84.28% | 91.00% | **NEAR** |
...
| Witness | Testimony | Filing Impact |
|---------|-----------|---------------|
| **FNB Legal Department** | Confirm mandate fraud, unauthorized banking changes | Commercial Crime +5% |
| **Stock2Shop Officials** | Confirm API breakage timeline caused by Sage takeover | POPIA +3% |
| **Sage South Africa** | Confirm false death claim used to transfer account | CIPC +4% |
| **Linda Kruger** | Confirm instructions received for banking detail changes | All criminal filings +5% |
| **Gayane Williams** | Confirm instructions received for domain change | POPIA +3% |
