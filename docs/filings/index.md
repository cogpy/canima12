...
**Last Updated:** 2026-06-01 (v34 — forum-specific SCA response and multi-forum filing pack)
...
> **v34 Forum-Specific SCA Response Layer (2026-06-01):** Peter Andrew Faucitt’s 1 June 2026 SCA petition is now routed through the corrected forum-specific multi-track filing pack. Use the [SCA response bundle](./2026-06-01-sca-response-bundle/) for the High Court Rule 42 notice/founding-affidavit framework, SCA opposing affidavit, SAPS complainant statement, NPA and SARS referral letters, CIPC CoR135.1-style complaint narrative, and Information Regulator POPIA complaint statement.
...
|-------------|----------------|---------|--------|
| **SCA Response Bundle v34** | [2026-06-01 forum-specific filing pack](./2026-06-01-sca-response-bundle/) | Corrected High Court, SCA, SAPS, NPA, SARS, CIPC and POPIA filing formats after EVENT_180 | **ACTIVE** |
...
| **SCA Response Bundle Layer (2026-06-01)** | Added, consolidated and corrected into the v34 forum-specific filing pack routing EVENT_180 through SCA opposition, Rule 42/common-law rescission, SAPS complainant statement, CIPC CoR135.1 narrative, POPIA complaint statement, Commercial Crime referral, and NPA/SARS tax-risk referral while preserving burden-of-proof boundaries. |
...
### 2026-06-01 — Complete v34 SCA response and forum-specific filing pack

The complete v34 pack replaces the earlier supplement-style v31 materials, the v32 baseline and the v33 memorandum-style consolidation. It preserves the strongest historical evidence synthesis while presenting each track in the expected official format: High Court Rule 42 notice/founding affidavit, SCA opposing affidavit, SAPS complainant statement, NPA and SARS referral letters, CIPC CoR135.1-style complaint narrative and Information Regulator POPIA complaint statement.

- [Bundle index and action matrix](2026-06-01-sca-response-bundle/)
- [High Court Rule 42 notice, draft order and founding-affidavit framework](2026-06-01-sca-response-bundle/CIVIL_RULE42_RESPONSE.md)
- [SCA opposing / answering affidavit](2026-06-01-sca-response-bundle/CIVIL_SCA_OPPOSITION.md)
- [SAPS complainant statement for perjury and defeating-justice investigation](2026-06-01-sca-response-bundle/CRIMINAL_PERJURY_AND_DEFEATING_JUSTICE.md)
- [NPA / Commercial Crime referral letter](2026-06-01-sca-response-bundle/NPA_COMMERCIAL_CRIME.md)
- [SARS Criminal Investigations / NPA tax-risk referral letter](2026-06-01-sca-response-bundle/NPA_SARS_TAX_FRAUD.md)
- [CIPC CoR135.1-style Companies Act complaint narrative](2026-06-01-sca-response-bundle/CIPC_COMPANIES_ACT.md)
- [Information Regulator POPIA complaint statement](2026-06-01-sca-response-bundle/POPIA_COMPLAINT.md)
